...
public class MainActivity extends AppCompatActivity {
    ...
    private static class MyGraphicView extends View {
        ...
        protected void onDraw(Canvas canvas) {
            ...
            int picX = (this.getWidth() - picture.getWidth()) / 2;  //가운데 맞추기 왼쪽위가 (0,0)
            ...
            *//*bMask = new BlurMaskFilter(30, BlurMaskFilter.Blur.NORMAL);
            ...
            canvas.drawBitmap(picture, picX, picY, paint);*//*
            //picture.recycle(); // API 30 이전이면 heap에 할당하므로 호출 필수, 이후는 VM에 할당
            ...
            *//*bMask = new BlurMaskFilter (30, BlurMaskFilter.Blur.SOLID);
            ...
            //picture = null; // API 30이후 VM 할당은 자동으로 메모리 환원 가능*/
